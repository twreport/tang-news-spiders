...
class SendWeixinMsg(object):
    def process_item(self, item, spider):
        ...
        if is_local_result == 1:
            ...
            text += 'https://m.weibo.cn/search?' + urlencode(url_obj)
            text += '\n'
